...
ginkgo_test_with_coverage () {
  #echodo export GOROOT=/usr/local/go
  #echodo export GOPATH=/go
  echo "SHREE TEST1"; echo $GOROOT; echo $GOPATH; echo $PATH
  ...
  (
    ...
    echo "SHREE TEST2"; echo $GOBIN;  echo $GOPATH; 
    export PATH=$PATH:$GOBIN
    ls $GOBIN; echo $PATH
    #echodo go get github.com/F5Networks/cf-bigip-ctlr/vendor/github.com/onsi/gomega
    #echodo go get github.com/F5Networks/cf-bigip-ctlr/vendor/github.com/onsi/ginkgo
    #echodo ginkgo
